...
@export var split_line_thickness: float = 6.0
@export var split_line_color: Color = Color.RED
...
func _move_cameras():
  ...
  camera1.zoom = Vector2(4, 4)
  camera2.zoom = Vector2(4, 4)
...
func _update_splitscreen():
  ...
  # print("split_active ", _get_split_state())
  # print("player1_position ", player1_position)
  # print("player2_position ", player2_position)
  # print("split_line_thickness ", thickness)
  # print("split_line_color ", split_line_color)
  # print('----------')
